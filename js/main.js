...
const SONGS = [
  ...
  { no: "045", title: "Macaron Madness", yt: null },
  { no: "046", title: "Muffin Else Matters", yt: null },
];
...
const I18N = {
  en: {
    ...
    about_p3: "Find us on Spotify, YouTube, TikTok, Instagram and X — and turn every meal into a party.",
  ...
  ja: {
    ...
    about_p3: "Spotify・YouTube・TikTok・Instagram・X で配信中。毎日の食事をパーティーに。",
    footer_tag: "Food × EDM × Neon",
    badge_mv: "MV",
    badge_stream: "配信中",
    lang_button: "English",
